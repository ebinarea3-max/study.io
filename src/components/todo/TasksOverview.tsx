...
export function TasksOverview() {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto space-y-4 px-3.5 sm:px-6 py-4 pb-24 md:pb-12 animate-in fade-in duration-200">
      ...
      <div className="hud-surface hud-corner-bracket border border-white/[0.08] rounded-2xl p-4 sm:p-4.5 space-y-2 relative overflow-hidden group">
      ...
      <div className="hud-surface hud-corner-bracket border border-white/[0.08] rounded-2xl p-4 sm:p-5 space-y-3.5 relative overflow-hidden">
        {/* Header Row */}
