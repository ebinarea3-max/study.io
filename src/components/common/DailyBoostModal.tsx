    ...
    >
      <div className="relative w-full max-w-md bg-slate-900 border border-slate-700/80 rounded-3xl shadow-2xl p-6 sm:p-8 text-center overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          {/* Top Pill */}
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-300 text-[11px] font-black tracking-widest uppercase mb-3">
          ...
          <div className="relative my-2 px-2">
            <Quote className="w-5 h-5 text-slate-600/70 absolute -top-3 -left-1 transform -scale-x-100 opacity-60" />
            <h2
          ...
          {boostItem.tip && (
            <div className="w-full mt-3 p-3 rounded-2xl bg-slate-950/60 border border-slate-800/90 text-left">
              <div className="text-[10px] font-extrabold uppercase tracking-wider text-emerald-400 flex items-center gap-1 mb-0.5">
          ...
          <div className="my-4 w-full grid grid-cols-2 gap-3">
            <div className="p-3 rounded-2xl bg-slate-950/70 border border-slate-800/90 flex items-center gap-2.5 text-left">
