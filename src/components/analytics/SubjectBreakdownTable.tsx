...
export function SubjectBreakdownTable({ data, totalSeconds }: SubjectBreakdownTableProps) {
  ...
  return (
    <div className="rounded-2xl bg-white dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800/80 overflow-hidden shadow-xl">
      <div className="overflow-x-auto pb-2 scrollbar-thin">
        <table className="w-full text-left text-xs border-collapse min-w-[560px]">
          <thead>
            <tr className="border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/80 text-slate-600 dark:text-slate-400 font-bold uppercase text-[10px] tracking-wider">
          ...
          <tbody className="divide-y divide-slate-100 dark:divide-slate-800/60">
            {data.map(item => {
              ...
              return (
                <tr key={item.name} className="hover:bg-slate-50 dark:hover:bg-slate-900/50 transition-colors">
                  ...
                  {/* % Distribution */}
                  <td className="py-3.5 px-4">
                    <span className="inline-flex px-2 py-0.5 rounded-md bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono font-bold text-slate-800 dark:text-slate-200 text-[11px]">
                      {item.percentage}%
                    </span>
                  </td>
                  ...
                  <td className="py-3.5 px-4 text-right w-40">
                    <div className="h-2 w-full rounded-full bg-slate-200 dark:bg-slate-900 overflow-hidden ml-auto">
                      <div
          ...
          <tfoot>
            <tr className="bg-slate-50 dark:bg-slate-900/90 font-bold text-slate-900 dark:text-white border-t border-slate-200 dark:border-slate-800">
              ...
              <td className="py-3 px-4 text-right text-emerald-600 dark:text-emerald-400 text-[11px]">Complete</td>
            </tr>
          </tfoot>
        </table>
      </div>
